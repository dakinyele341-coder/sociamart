...
// Every item carries a seller_id so own-post checks and follow state behave.
export const DEMO_PRODUCTS = [
  {
    ...
    is_available: true,
    distance_m: 1200,
    seller: { id: 'demo-seller-1', full_name: 'Bisi Couture', is_verified: true, rating: 4.8 },
  ...
  },
  {
    ...
    is_available: true,
    distance_m: 8400,
    seller: { id: 'demo-seller-2', full_name: 'Gadget Plug', is_verified: false, rating: 4.2 },
  ...
  },
  {
    ...
    is_available: true,
    distance_m: 600,
    seller: { id: 'demo-seller-3', full_name: 'Mama Tunde Foods', is_verified: true, rating: 4.9 },
  ...
  },
  {
    ...
    is_available: true,
    distance_m: 15300,
    seller: { id: 'demo-seller-4', full_name: 'Naija Crafts', is_verified: true, rating: 4.7 },
